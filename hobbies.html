...
<div class="page-intro">
    ...
    <p>When I get some free time, I learn more about the world. My main focus areas today are computer science and cryptography, but I also try to learn about some other unrelated topics I find interesting, like longevity, space exploration, and the deep intricacies of finance. I follow along to free online university courses, read books, listen to podcasts, and generally do my best to stay constantly curious about the world. </p>
    <p>I also like to cook, play golf, and hang out with my family, friends, and my dog Manu.</p>
</div>

<details>
    <summary>Personal Curriculum</summary>
    <div class="details-content">
        <p>I spend at least a few hours a week going through materials from high-quality educational courses. Here are some of the best materials I've gone through recently:</p>
        <ul>
...
<details>
    ...
    <div class="details-content">
        <p>When the weather permits, you can find me on the golf course. Golf has a bad reputation as an elitist country club sport. That can sometimes be true (depends where you play!).</p>
        <p>But golf also pushes me to be outside in nature, with a few friends and my phone away, unplugged from the rest of the world and focused solely on getting the little white ball into the hole in as few strokes as possible. It's a mental and physical challenge and it takes tons of discipline to get good at golf (I am still working on getting 'good' at golf).</p>
    </div>
</details>